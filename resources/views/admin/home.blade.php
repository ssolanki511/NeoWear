    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-4">
            ...
            <a href="{{ route('products') }}"
                ...
                <p class="text-xs text-gray-500 mb-1">Total Products: <span class="font-semibold">100</span></p>
            ...
            <a href="{{ route('orders') }}"
                ...
                <p class="text-xs text-gray-500 mb-1">Total Orders: <span class="font-semibold">100</span></p>
            ...
            <a href="{{ route('users') }}"
                ...
                <p class="text-xs text-gray-500 mb-1">Total Users: <span class="font-semibold">100</span></p>
            ...
            <a href="{{ route('inquires') }}"
                ...
                <p class="text-xs text-gray-500 mb-1">Total Inquiries: <span class="font-semibold">100</span></p>
            ...
            <a href="{{ route('offers') }}"
                ...
                <p class="text-xs text-gray-500 mb-1">Total Offers: <span class="font-semibold">100</span></p>
            ...
            <a href="{{ route('categories') }}"
                ...
                <p class="text-xs text-gray-500 mb-1">Total Categories: <span class="font-semibold">100</span></p>
