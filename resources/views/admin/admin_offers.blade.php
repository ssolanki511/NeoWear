                        ...
                        <tbody>
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">Summer Sale</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">25%</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">₹500 - ₹5000</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <span class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">Active</span>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button onclick="window.location.href='{{ url('edit_offer') }}'"
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">Flash Deal</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">40%</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">₹1000 - ₹10000</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <span class="px-2 py-1 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-full">Upcoming</span>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
