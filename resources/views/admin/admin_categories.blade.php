                ...
                <div class="w-full flex flex-col lg:flex-row justify-between p-2 border-b-2 border-gray-200 gap-4">
                    ...
                    <div class="mx-3">
                        <form action="#"
                         ...
                         <button onclick="window.location.href='{{ url('add_category') }}'" type="button"
                    ...
                    <table class="w-full text-left table-auto min-w-max">
                        <thead>
                            <tr class="border-b border-slate-300">
                                ...
                                <th class="p-4 text-sm font-normal leading-none text-slate-500">Products Count</th>
                        ...
                        <tbody>
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">Wearables</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">Smart watches, fitness trackers, and wearable technology</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">24</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button onclick="window.location.href='{{ url('edit_category') }}'"
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">Audio</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">Headphones, speakers, and audio accessories</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">18</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button class="font-medium text-blue-600 hover:underline cursor-pointer">Edit</button>
                                    <button
                                        class="font-medium text-red-600 hover:underline cursor-pointer ms-3">Remove</button>
                                </td>
                            </tr>
