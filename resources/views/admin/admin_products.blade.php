                    ...
                    <form action="#" class="flex flex-wrap gap-3">
                        ...
                        <div class="w-full sm:w-auto">
                            <div class="w-full max-w-sm relative">
                                <div class="relative">
                                    <input
                                        class="bg-white w-full sm:w-auto pr-11 h-10 pl-3 py-2 placeholder:text-slate-400 text-slate-700 text-sm border border-slate-500 rounded transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md"
                ...
                <table class="w-full text-left table-auto min-w-max">
                    ...
                    <tbody>
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="p-4 border-b border-slate-500 py-5">
                                <p class="block font-semibold text-sm text-slate-800">Nike Air Max</p>
                            </td>
                            <td class="p-4 border-b border-slate-500 py-5">
                                <p class="text-sm text-slate-500">Men's Shoes</p>
                            </td>
                            <td class="p-4 border-b border-slate-500 py-5">
                            ...
                            <td class="p-4 border-b border-slate-500 py-5">
                                ...
                                <a href="{{ route('edit_product_form') }}"
                                    class="font-medium text-green-600 hover:underline cursor-pointer ms-3">Edit</a>
                                <a href="#"
                                    class="font-medium text-red-600 hover:underline cursor-pointer ms-3">Remove</a>
                            </td>
                        </tr>
                        <tr class="hover:bg-slate-50">
                            <td class="p-4 border-b border-slate-500 py-5">
                            ...
                            <td class="p-4 border-b border-slate-500 py-5">
                                <p class="text-sm text-slate-500">7%</p>
                            </td>
                            <td class="p-4 border-b border-slate-500 py-5">
                                <a href="{{ route('view_product') }}"
                                    class="font-medium text-blue-600 hover:underline cursor-pointer">View</a>
