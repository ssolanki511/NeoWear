                        ...
                        <tbody>
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">#ORD-001</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                ...
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">Smart Watch, Headphones</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm font-medium text-slate-800">₹4,999.00</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                ...
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button onclick="window.location.href='{{ url('view_order') }}'"
                                        class="font-medium text-blue-600 hover:underline cursor-pointer">View</button>

                                    <button onclick="window.location.href='{{ url('edit_order') }}'"
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">#ORD-002</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <div class="flex items-center">
                                        <img src="https://demos.creative-tim.com/corporate-ui-dashboard-pro/assets/img/kam-idris-_HqHX3LBN18-unsplash.jpg"
                                            alt="Customer" class="w-8 h-8 object-cover rounded-full mr-3" />
                                        <div>
                                            <p class="text-sm font-medium text-slate-800">Jane Smith</p>
                                            <p class="text-xs text-slate-500">jane@example.com</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">Wireless Earbuds</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm font-medium text-slate-800">₹2,499.00</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                ...
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button class="font-medium text-blue-600 hover:underline cursor-pointer">View</button>
                                    <button class="font-medium text-green-600 hover:underline cursor-pointer ms-3">Edit</button>
                                    <button
                                        class="font-medium text-red-600 hover:underline cursor-pointer ms-3">Cancel</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
