        ...
        <div class="relative bg-white rounded-lg shadow-sm border-2 border-gray-200">
            ...
            <div class="p-4 md:p-5">
                <div class="mb-4">
                    ...
                    <span class="ml-2 text-gray-900">#ORD-001</span>
                </div>
                <div class="mb-4">
                    <span class="font-semibold text-gray-700">Customer:</span>
                    <span class="ml-2 text-gray-900">John Doe</span>
                    <span class="ml-2 text-sm text-gray-500">(john@example.com)</span>
                </div>
                <div class="mb-4">
                    <span class="font-semibold text-gray-700">Status:</span>
                    <span class="ml-2 px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">Processing</span>
                </div>
                <div class="mb-4">
                    <span class="font-semibold text-gray-700">Order Date:</span>
                    <span class="ml-2 text-gray-900">2024-01-15</span>
                </div>
                <div class="mb-4">
                    <span class="font-semibold text-gray-700">Shipping Address:</span>
                    <span class="ml-2 text-gray-900">123 Main Street, City, Country</span>
                </div>
                <div class="mb-4">
                    <span class="font-semibold text-gray-700">Payment Method:</span>
                    <span class="ml-2 text-gray-900">Credit Card</span>
                </div>
                <div class="mb-6">
                    ...
                    <table class="min-w-full mt-2 border border-gray-200 rounded">
                        ...
                        <tbody>
                            <tr>
                                <td class="px-4 py-2 text-gray-800">Smart Watch</td>
                                <td class="px-4 py-2 text-gray-800">1</td>
                                <td class="px-4 py-2 text-gray-800">₹3,000.00</td>
                                <td class="px-4 py-2 text-gray-800">₹3,000.00</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-2 text-gray-800">Headphones</td>
                                <td class="px-4 py-2 text-gray-800">1</td>
                                <td class="px-4 py-2 text-gray-800">₹1,999.00</td>
                                <td class="px-4 py-2 text-gray-800">₹1,999.00</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr class="bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-gray-900 font-bold">₹4,999.00</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
