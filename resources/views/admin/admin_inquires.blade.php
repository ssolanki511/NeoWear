                    ...
                    <table class="w-full text-left table-auto min-w-max">
                        ...
                        <tbody>
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-800 max-w-xs truncate">I have a question about my recent order. The delivery seems to be delayed and I need to know the current status.</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">2024-01-15</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button
                                        onclick="window.location.href='{{ url('view_inquiry') }}'"
                                        class="font-medium text-blue-600 hover:underline cursor-pointer">View</button>
                                    <button
                                        onclick="window.location.href='{{ url('reply_inquiry') }}'"
                                        class="font-medium text-green-600 hover:underline cursor-pointer ms-3">Reply</button>
                                    <button
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">Jane Smith</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">jane@example.com</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-800 max-w-xs truncate">I would like to return a product I purchased last week. Can you please provide me with the return process?</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">2024-01-10</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button onclick="window.location.href='{{ url('view_inquiry') }}'"
                                        class="font-medium text-blue-600 hover:underline cursor-pointer">View</button>
                                    <button onclick="window.location.href='{{ url('reply_inquiry') }}'"
                                        class="font-medium text-green-600 hover:underline cursor-pointer ms-3">Reply</button>
                                    <button
                                        class="font-medium text-red-600 hover:underline cursor-pointer ms-3">Remove</button>
                                </td>
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">Mike Johnson</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">mike@example.com</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-800 max-w-xs truncate">I'm interested in your new product line. Do you have any special offers or discounts available?</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">2024-01-08</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button onclick="window.location.href='{{ url('view_inquiry') }}'"
                                        class="font-medium text-blue-600 hover:underline cursor-pointer">View</button>
