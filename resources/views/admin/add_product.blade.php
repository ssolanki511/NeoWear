...
@section('main_content')
    <div class="container mx-auto p-4 max-w-2xl">
        <div id="add_product-modal" tabindex="-1"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow-sm border-2 border-gray-200">
                    ...
                    <form action="{{ route('add_product') }}" method="post" id="add_product_form" enctype="multipart/form-data" class="product-form p-4 md:p-5">
                        @csrf
        ...
        {{-- <div id="edit_product-modal" tabindex="-1"
            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-full backdrop-blur-sm bg-gray-900/30">
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow-sm border-2 border-gray-200">
                    <!-- Modal header -->
                    <div class="flex items-center justify-between p-4 md:p-5 border-b border-gray-200">
                        ...
                        <button id="close-edit-product-modal" type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <form id="edit_product_form" enctype="multipart/form-data" class="product-form p-4 md:p-5">
                        @csrf
                        <div class="grid gap-4 mb-4 grid-cols-1 md:grid-cols-2">
                            <div>
                            ...
                            <div>
                                <label for="edit_p_offer"
                                    class="block mb-2 text-sm font-medium text-gray-900">Offer</label>
                                <input type="number" name="p_offer" id="p_offer"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"
                                    placeholder="Offer">
                            </div>
                            <div>
                                <label for="edit_mydropdown"
                                    class="block mb-2 text-sm font-medium text-gray-900">Category</label>
                                ...
                                <div id="edit_dropdown-error" class="error"></div>
                            </div>
                            <div>
                                <label for="edit_img_file"
                            ...
                            <div class="md:col-span-2">
                                <label for="edit_product_dis" class="block mb-2 text-sm font-medium text-gray-900">Product
                                    Description</label>
