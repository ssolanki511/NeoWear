                    ...
                    <table class="w-full text-left table-auto min-w-max">
                        ...
                        <tbody>
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="block font-semibold text-sm text-slate-800">ABC 1</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">abc@mail</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <p class="text-sm text-slate-500">Normal</p>
                                </td>
                                <td class="p-4 border-b border-slate-500 py-5">
                                    <button onclick="window.location.href='{{ url('edit_user') }}'"
