            ...
            <div class="relative bg-white rounded-lg shadow-sm border-2 border-gray-200">
                ...
                <div class="p-4 md:p-5">
                    <div class="mb-4">
                        ...
                        <span class="ml-2 text-gray-900">#INQ-001</span>
                    </div>
                    <div class="mb-4">
                        <span class="font-semibold text-gray-700">Customer:</span>
                        <span class="ml-2 text-gray-900">Jane Smith</span>
                        <span class="ml-2 text-sm text-gray-500">(jane@example.com)</span>
                    </div>
                    <div class="mb-4">
                        <span class="font-semibold text-gray-700">Message:</span>
                        <span class="ml-2 text-gray-900">Hi, I would like to know if the Smart Watch is available in black color?</span>
                    </div>
                    <div class="mb-4">
                        <span class="font-semibold text-gray-700">Date:</span>
                        <span class="ml-2 text-gray-900">2024-01-20</span>
                    </div>
                    <form action="{{ route('reply_inquiry') }}" method="post" class="mt-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" id="user_email" name="user_email" value="jane@example.com" readonly
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="reply" name="reply" rows="4" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Type your reply here..."></textarea>
                            @error('reply')
