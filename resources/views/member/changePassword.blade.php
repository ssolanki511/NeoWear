...
@section('main')
    <div class="change-password-main-container">
        <div class="form-container">
            ...
            <form action="{{ url('/changePasswordProfile') }}" method="post">
                ...
                <div class="input-field">
                    <input type="password" name="oldpass" id="oldpass" class="input" value="{{ old('oldpass') }}" placeholder="Old Password">
                    @error('oldpass')
        ...
        <div class="image-box">
            <img src="{{ asset('images/background/changePassword.jpg') }}" alt="Simple Image">
        </div>
    </div>
@endsection
